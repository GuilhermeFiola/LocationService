...
namespace MicroserviceCore.LocationService.Persistence
{
    public class InMemoryLocationRecordRepository: ILocationRecordRepository{
        ...
        public static Dictionary<Guid, SortedList<long, LocationRecord>> locationRecords;
        ...
        {
            var memberRecord = getMemberRecords(locationRecord.MemberID);

            memberRecord.Add(locationRecord.Timestamp, locationRecord);
